...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate {
    ...
    let fortuneMessages = [
        ...
        "오늘 배운 내용을 블로그에 정리하면 좋을 것 같아요.",
        "질문하기를 두려워하지 마세요. 모두가 초보자였습니다.",
        "오늘은 CS 기초 공부가 빛을 발하는 날이 될 거예요.",
        "MVP부터 시작하세요. 완벽한 첫 버전은 없습니다.",
        "오늘은 기능 구현보다 버그 수정에 집중하는 게 좋을 듯해요.",
        "커밋 메시지를 명확하게 작성하면 미래의 당신이 감사할 거예요.",
        "오늘은 코드보다 기획이 더 중요한 날입니다.",
        "데이터베이스 백업을 잊지 마세요... 정말 중요해요! 💾 ",
        ...
        "git blame은 범인 찾기가 아니라 히스토리 확인용입니다! 😊 ",
        ...
        "임포스터 증후군은 성장의 신호입니다.",
        "모든 시니어 개발자도 당신과 같은 주니어 시절이 있었어요.",
        ...
        "스트레칭을 자주 하세요. 개발자의 목과 허리는 소중하니까요!",
    ...
    override func viewDidLoad() {
        ...
        MessagesTableView.register(nib, forCellReuseIdentifier: "MessageCell")
    ...
    @IBAction func FortuneButtonTapped(_ sender: UIButton) {
        guard let fortune = fortuneMessages.randomElement() else { return }
        let fortuneMessage = Message(text: "오늘의 운세: \(fortune)", isMyMessage: false, timestamp: Date())
        messages.append(fortuneMessage)
    ...
    func sendMessage() {
        ...
        let myMessage = Message(text: text, isMyMessage: true, timestamp: Date())
